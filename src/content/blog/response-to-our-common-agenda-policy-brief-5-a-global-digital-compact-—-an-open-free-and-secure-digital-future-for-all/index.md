...
2. The development of a framework for the agile governance of AI combining international and national technical standards and norms.
...
By following this path forward, and in conjunction with the other objectives and actions to be included in the Global Digital Compact, the multilateral system can hopefully lead the way towards a multilateral regime complex for AI.
